...
export default async function StatisticsPage() {
  ...
  // Wir holen uns alle relevanten Daten für die Stats
  const [expenses, energyReadings, chores, bucketItems] = await Promise.all([
      ...
      <div className="max-w-4xl mx-auto space-y-8 pb-32">
        ...
        <section className="grid grid-cols-2 md:grid-cols-4 gap-4">
           ...
           <div className="bg-stone-900 text-white p-6 rounded-3xl">
             ...
             <p className="text-[9px] text-stone-500 mt-1">Historie</p>
           </div>
        </section>

        {/* Interaktive Diagramme (Client Component) */}
        <StatCharts expenses={expenses} energy={energyReadings} />
